...
public class BakliyatAdapter extends RecyclerView.Adapter<BakliyatAdapter.MyViewHolder> {
    ...
    public BakliyatAdapter(ArrayList<String> imageList, ArrayList<String> prodcutList, ArrayList<String> idList, ArrayList<String> katIdList, Context context) {
    ...
    @NonNull
    @Override
    public BakliyatAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BakliyatAdapter.MyViewHolder holder, int position) {
